          ...
          Column(
            children: [
              ElevatedButton(
                  ...
                  style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all(Color.fromARGB(255, 255, 193, 59))),
              ...
              AnimatedContainer(
                ...
                decoration: const BoxDecoration(color: Color.fromARGB(255, 137, 255, 59)),
              ),
              const SizedBox(
                height: 10,
              ),
          ...
          Column(
            children: [
              ElevatedButton(
                  ...
                  style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 194, 33, 243))),
                  child: const SizedBox(
                    width: 50.0,
                    height: 70.0,
                    child: Center(
              ...
              AnimatedContainer(
                ...
                decoration: const BoxDecoration(color: Color.fromARGB(255, 243, 145, 33)),
              ),
              const SizedBox(
                height: 10,
              ),
